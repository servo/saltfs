# This module is a copy of the salt/states/pip_state.py module from Salt
# version 2015.5.8 (git revision a26c10a811fef3c7deca0559f431713f69a83289),
# with the patches from the following two PRs backported:
# - https://github.com/saltstack/salt/pull/33180
# - https://github.com/saltstack/salt/pull/33383
# These patches allow the module to work with old and new pips after an
# change in the internals of pip in pip version 8.1.2.
#
# The original copyright and licensing notice for this module is reproduced
# below in the double-# comment block:
#
