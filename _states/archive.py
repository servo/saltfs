# This module is backported from Salt 2016.3
# (at commit f4f3ee69bac5b17a80d09e18a37a00f0a6a7ff9c).
# No modifications have been made with the exception of
# the addition of this header comment.
#
# The original copyright and licensing notice for the methods from the
# archive.py state module is reproduced below in the double-# comment block:
#
